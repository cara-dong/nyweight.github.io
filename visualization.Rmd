...
ggplot(county_year_data, aes(x = year, y = ave_overweight_percent)) + 
  ...
  theme(legend.position = "none")
```
interpretation: By analyzing two plots, it can be concluded that there is a consistant decrease in overweight rate for students in NY state over years. However, it should be noted that 2016 and 2017's data have some outliers, so additional analysis will be performed excluding those outliers. 

```{r}
# exclude outliers in 2016 and 2017
```
...
custom_order <- county_ave_data[order(county_ave_data$ave_healthy_percent), "county"]
...
ggplot(county_data, aes(x = percent_asian, y = percent_overweight)) +
  geom_point() +
  labs(title = "County-Level Percentage Overweight vs. Percent of Asians",
       x = "Percent of Asians",
       y = "Percentage Overweight")

ggplot(county_data, aes(x = percent_white, y = percent_overweight)) +
  geom_point() +
  labs(title = "County-Level Percentage Overweight vs. Percent of White",
       x = "Percent of White",
       y = "Percentage Overweight")

ggplot(county_data, aes(x = percent_black, y = percent_overweight)) +
  geom_point() +
  labs(title = "County-Level Percentage Overweight vs. Percent of Black",
       x = "Percent of Black",
       y = "Percentage Overweight")

ggplot(county_data, aes(x = percent_am_ind, y = percent_overweight)) +
  geom_point() +
  labs(title = "County-Level Percentage Overweight vs. Percent of American Indian",
       x = "Percent of American Indian",
       y = "Percentage Overweight")

ggplot(county_data, aes(x = percent_hisp, y = percent_overweight)) +
  geom_point() +
  labs(title = "County-Level Percentage Overweight vs. Percent of Hispanic",
       x = "Percent of hispanic",
       y = "Percentage Overweight")
```
